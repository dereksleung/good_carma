...
#
# APARTMENT CONFIGURATION DISABLED FOR NOW - SUBSTITUTE CONTROLLER LOGIC AND CANCANCAN AUTHORIZATIONS TO SEPARATE COMPANY INFORMATION.
# SELECT THE configure do-end block to REENABLE.
...
# Rails.application.config.middleware.insert_before(Rack::Cors, Apartment::Elevators::FirstSubdomain)
